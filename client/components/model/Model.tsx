...
const Model = () => {
  //redux state
  const { open, title, body }: ModelProps = useSelector(
  ...
  return (
    <div
      className={`${
        open ? "flex" : "hidden"
      } absolute top-0 left-0 w-screen h-screen z-50 bg-black bg-opacity-60 backdrop-blur-md justify-center items-center`}
    >
