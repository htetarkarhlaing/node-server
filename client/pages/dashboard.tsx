...
import ChatList from "../components/page-components/Chatlist";
        ...
        <div className="flex items-center">
          <div className="relative">
            <input
              type="text"
              placeholder="Search"
              className="outline-none p-1 px-2 placeholder:text-gray-200 placeholder:text-sm  text-sm text-gray-200 rounded-md bg-gray-500 bg-opacity-50"
            />
      ...
      <div className="grid grid-cols-12 gap-4 pt-16 px-20 mx-30">
        <div className="col-span-4">
          ...
          <div className="flex my-2">
            <button className="text-gray-200 bg-gray-500 bg-opacity-40 p-0.5 px-2 rounded-md text-sm">
              Open
            </button>
            <button className="text-gray-200 bg-gray-500 bg-opacity-40 p-0.5 px-2 rounded-md text-sm mx-2">
              Done
            </button>
            <button className="text-gray-200 p-0.5 px-2 border-dotted border border-gray-100 border-opacity-80 rounded-md text-sm">
              Unread
            </button>
          </div>
          <ChatList name="hey" msg="You: 5ting!!" time="12mins" />
        </div>
        <div className="w-0.5 bg-gray-50 opacity-20 ml-8"></div>
        ...
        <div className=" h-auto col-span-7 rounded-lg overflow-hidden">
          <div className="p-2 py-3 bg-gray-500 flex items-center justify-between bg-opacity-50">
            <div className="flex items-center">
              ...
              <h1 className="text-gray-200 text-xl mx-3">
          ...
          <div className="bg-white bg-opacity-10 p-5">
            ...
            <div className="flex items-end mb-2">
              ...
              <div className="mx-2">
                ...
                <p className="bg-gray-500 bg-opacity-50 px-2 p-1 rounded-lg text-gray-200 text-sm">
                  Server pw tin pyy pr own Htet ArKar
                </p>
              </div>
            </div>
            <div className="flex items-end mb-2">
          ...
          <div className="flex items-center bg-purple-500 bg-opacity-50 p-2">
            ...
            <input
              type="text"
              placeholder="Aa"
              className="p-1 px-2 w-full rounded-lg bg-gray-500 bg-opacity-50 text-sm text-gray-200 placeholder:text-gray-200 outline-none placeholder:text-sm "
            />
